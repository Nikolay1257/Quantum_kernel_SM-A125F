 ...
 **************************************************/
#define SEG3_GPU_DVFS_FREQ0			(820000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ1			(640000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ2			(540000)	/* KHz */

#define SEG3_GPU_DVFS_VOLT0			(86240)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT1			(76240)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT2			(71240)		/* mV x 100 */
